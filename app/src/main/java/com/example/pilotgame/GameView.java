...
import com.example.pilotgame.entity.Asteroid;
import com.example.pilotgame.entity.Background;
import com.example.pilotgame.entity.Bullet;
import com.example.pilotgame.entity.Flight;
...
public class GameView extends SurfaceView implements Runnable {
    ...
    private void update() {
        ...
        for (Asteroid asteroid : asteroids) {
            ...
            if ((asteroid.getX() + asteroid.getWidth()) < 0) {
                ...
                asteroid.setY(ThreadLocalRandom.current().nextInt(asteroid.getHeight()/3, screenY - asteroid.getHeight())); // случайное положение относительно оси Y
    ...
    private void waitBeforeExiting() {
        // ввод вспомогательного потока в сон на 1 секунды
        try {
            Thread.sleep(1000);
